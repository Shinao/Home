...
application = Application(
    [
        ...
        (r'^/api/(?P<camera_id>\d+)/(?P<api_key>\d+)/(?P<op>enable|disable)/?$', handlers.ApiHandler),
        (r'^/config/(?P<camera_id>\d+)/(?P<op>get|set|rem|set_preview|enable|disable)/?$', handlers.ConfigHandler),
